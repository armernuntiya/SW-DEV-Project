        ...
        <div className="flex flex-col py-4 items-center g-12">
            ...
            <div className="flex flex-col py-4 items-center gap-12">
                <div className="flex flex-col items-center gap-5">
                    <TextField id="outlined-basic" placeholder="Email" variant="outlined" InputProps={{sx: {borderRadius:9999,width:399,fontSize:16, height:40,paddingBottom:2,textAlign:'center',paddingTop:2}}} InputLabelProps={{}} />
                ...
                <div className="flex flex-col items-center gap-2 self-stretch">
                    <button type="submit" className="flex h-9 px-6 items-center bg-red-700 text-white rounded-full font-normal font-sans text-sm hover:bg-red-800 hover:shadow-md">SIGN IN</button>
                    <div className="flex flex-row items-center gap-1">
                        ...
                        <Link href='' className="w-129 text-red-700 text-center font-sans text-sm not-italic font-light leading-6">Sign up</Link>
                    </div>
