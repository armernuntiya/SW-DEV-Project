    ...
    return(
        ...
        <div className="flex flex-col p-10 justify-center items-center gap-4 rounded-3xl bg-white shadow-md h-140 w-280">
            ...
            <div className="flex flex-col gap-y-3 w-full">
                    ...
                    <select name='restaurant' id='restaurant' className="bg-red-50 border rounded-full h-10 w-full text-[#737373] px-5 border-black/25  placeholder:text-gray-500">
                        <option value="Hungry Nerd" >Hungry Nerd</option>
                        <option value="SeeFah" >SeeFah</option>
                    </select>
            </div>
