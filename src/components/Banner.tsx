...
export default function Banner() {
    const covers = ['/img/banner4.jpg','/img/banner2.jpg','/img/banner3.jpg','/img/banner5.jpg','/img/banner1.png']
    const [index,setIndex] = useState(0)

    return (
        <>
            <div className='flex flex-col shrink-0 items-start w-screen h-[550px]'>
                <Image src={covers[(index+5)%5]} alt='banner' width="0" height="0" sizes='100vw' priority className='w-full h-[550px] object-cover'/>
            </div>
